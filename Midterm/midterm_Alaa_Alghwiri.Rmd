...
my_beta_loglik <- function(unknowns, my_info)
{
  ...
  log_a <- # kind of like phi in Week6 Laplace slides
  log_b <- 
  ...
  log_lik + log(#derivative of inverse link a) + log(#derivative inverse b)
}
```
...
```{r, assemble_both_types_to_compare, eval=FALSE}
