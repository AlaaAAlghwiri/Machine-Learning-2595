---
title: "Introduction to Machine Learning Spring 2025 Homework: 6"
subtitle: "Assigned March 21, 2025; Due: March 31, 2025"
...
```{r, solution_for_1b_a, eval=FALSE}
### make the design matrix for the SMALL data
Xmat_quad_small <- 
```


```{r, solution_for_1b_b, eval=FALSE}
...
```{r, solution_for_2a_a, eval=FALSE}
### prior covariance matrix for the INFORMATIVE prior
B0_inform <- 
```


```{r, solution_for_2a_b, eval=FALSE}
...
file_for_train <- "hw6_train_data.csv"

train_df <- readr::read_csv(file_for_train, col_names = TRUE)

file_for_test <- "hw6_test_data.csv"
