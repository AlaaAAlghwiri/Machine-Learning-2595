...
```{r}
log_bernoulli_pmf(xobs = x, prob = 0.25)
```
...
It's the same as the mentioned ones.
...
a_new_uniform
b_new_uniform <- player_atbats + b_uniform
b_new_uniform
```
...
a_new_inform
b_new_inform <- player_atbats + b_inform
b_new_inform
```
...
b_new_uniform_season <- season_atbats + b_uniform
...
a_new_inform_season
b_new_inform_season <- season_atbats + b_inform
b_new_inform_season
```
