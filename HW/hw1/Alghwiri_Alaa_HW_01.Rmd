...
Two variables are displayed, corresponding to the `Height` and `Weight` features we specified in the formula for `mod2`. Weight does appear to have a significant relationship to the age of the abalone, but the height has a very wide confidence interval that does overlap with zero, making it statistically insignificant.
